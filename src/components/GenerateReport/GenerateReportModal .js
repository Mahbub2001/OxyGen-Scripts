  ...
  return (
    <div className="fixed z-50 inset-0 bg-opacity-40 flex items-center justify-center">
      <div className="bg-white p-6 rounded-2xl w-1/3 shadow-xl dark:bg-gray-700 dark:border-gray-600 dark:hover:bg-gray-600">
        <h2 className="text-xl font-semibold mb-6 text-gray-800 text-center dark:text-white">
          Generate Report
        </h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
            />
          </div>
